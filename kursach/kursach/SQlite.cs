...
namespace kursach
{
    class SQlite
    {
        ...
        public List<data> output()
        {
            ...
            while (reader.Read())
            {
                data st = new data
                {
                    ...
                    XoD = int.Parse(reader["Xod"].ToString()),
        ...
        bool make_add = true;
        public bool input(int time, string name , int XoD)
        {
            ...
            while (reader.Read())
            {
                if (reader["name"].ToString() == name)
                {
                    ...
                    {
                        {
                            sql = "UPDATE Hightscore SET time = " + time + " WHERE name = '" + name + "'" + XoD + "'";
            ...
            if (make_add == true)
            {
                ...
                sql = "INSERT INTO  Hightscore ( name, time , XoD) VALUES (" + "'" + name + "'" + "," + time + "," + XoD + " )";
